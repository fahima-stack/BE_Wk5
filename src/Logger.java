...
public interface Logger { //class can implement multiple interfaces unlike inheritance where you can only inherit one class 

/*
 * Difference between abstract class and interface:
 * -Interface doesn't define any method implementations
